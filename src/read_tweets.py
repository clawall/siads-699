...
def scrape_all_tweets(account_id_file, max_pages=None):
    with open(account_id_file, 'r') as csv_file:
        ...
        for account_ids in reader:
            ...
            all_tweets.extend(scrape_polititweet(account_id, max_pages=max_pages))
...
if __name__ == '__main__':
    ...
    tweets = scrape_all_tweets(args.account_id_file, max_pages=args.max_pages)
